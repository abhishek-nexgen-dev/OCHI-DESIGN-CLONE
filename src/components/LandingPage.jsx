...
const LandingPage = () => {
  ...
  useGSAP(() => {
    ...
    gsap.to(ImageRef.current, 
        { width: "10%" , duration: 0.8, ease: "power2.out"  }
    )
    ...
    <div className="w-screen h-screen bg-[#f2f2f2] flex flex-col">
      <div className="text-structure  px-[2vw] py-[2vw] flex flex-col justify-center w-full h-[82%] relative">
        ...
        <div className="masker font-[FounderGrotesque] flex h-fit">
          <h1 className="text-[9vw] uppercase flex items-center w-full">
            ...
            />
            <span className="mb-[1vh]" ref={text2Ref}>eye-opening</span>
          </h1>
        </div>
      ...
      <div className="w-full h-[18%] px-[2.5vw] py-[3vh] flex justify-between font-light border-t border-zinc-500">
        ...
        <div className="w-[20%] flex h-[5vh]">
            <button ref={StartProjectRef} className="border-1 rounded-3xl border-black px-[1vw] py-[0.5vh] uppercase text-[1.2vw]"  >Start The Project </button>
            <div  ref={OuterCircleRef} className="Outer_Circle relative border-[1px] border-black rounded-full w-[2.5vw] h-full ml-2 flex items-center justify-center">
                <div ref={InnerCircleRef} className="Inner_Circle bg-black  absolute z-10"></div>
