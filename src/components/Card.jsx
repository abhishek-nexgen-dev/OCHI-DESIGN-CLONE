...
const Card = ({ Title, Image_Url ,  CardHoverText}) => {
  ...
  let Handle_Card_Mouse_Leave = () => {
    ...
    //             <span key={index} className={`inline-block transition-transform duration-300 ease-in-out transform `}>
    //               {letter}
    //             </span>
    //           ))}
  ...
  useGSAP(() => {}, []);
  return (
    <div className="Card_Container w-[48%] h-[90vh] font-[NeueMontriyan] ">
